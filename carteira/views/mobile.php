...
<head>
    ...
    <link rel="stylesheet" href="../css/obreiro.css">
                        ...
                        <div class="card-inner">
                            <div class="card-back">
                                ...
                                <div class="card-content">
                                    ...
                                    <p id="data_consagracao">Data de Consagração: <?php echo date("d/m/Y", strtotime($linha['data_Consagracao'])); ?></p>
                                    <p id="documento">Documento: <?php echo htmlspecialchars($linha['documento']); ?></p>
                                    <p id="data_nascimento">Data de Nascimento: <?php echo date("d/m/Y", strtotime($linha['dataNascimento'])); ?></p>
                                    <p id="data_batismo">Data de Batismo: <?php echo date("d/m/Y", strtotime($linha['dataBatismo'])); ?></p>
                                    <p id="estado_civil">Estado Civil: <?php echo htmlspecialchars($linha['estadoCivil']); ?></p>
                            ...
                            <div class="card-front">
                                ...
                                <img id="img_foto" src="../../imagens/<?php echo htmlspecialchars($linha['arquivo']); ?>" alt="Foto" class="rounded-circle">
                            </div>
                        </div>
                    </div>
                </div>
