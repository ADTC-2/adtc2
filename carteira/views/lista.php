...
<head>
    ...
    <script>
    var userLevel = '<?php echo $_SESSION['nivel']; ?>';
    </script>
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">
                                    <i class="nav-icon fas fa-wallet"></i> Emissão de Carteiras
                                </h1>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="emitirTable" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Visualizar</th>
                                    <!-- A coluna "Imprimir Carteira" será adicionada condicionalmente -->
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
    ...
    $(document).ready(function() {
        var userLevel = window.userLevel; // Obtém o nível do usuário a partir da variável JavaScript
        ...
        var columns = [
            {
                ...
                "render": function(data, type, row) {
                    return '<input type="checkbox" class="row-select" value="' + row.matricula + '">';
                },
                "orderable": false,
            ...
            },
            {
                ...
                "title": "Arquivo",
                "render": function(data, type, row) {
                    return '<img src="../../imagens/' + data + '" class="img-thumbnail img-fluid" style="width: 100px; height: 100px;">';
                },
                "className": "text-center"
            },
            {
            ...
            },
            {
                ...
                "render": function(data, type, row) {
                    return '<a href="mobile.php?matricula=' + row.matricula + '" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></a>';
                },
                "orderable": false,
                "className": "text-center"
            }
        ...
        // Adiciona a coluna "Imprimir Carteira" se o nível não for "apoio"
        if (userLevel !== 'apoio') {
            columns.push({
                "data": null,
                "title": "Imprimir Carteira",
                "render": function(data, type, row) {
                    return '<a href="display_obreiro.php?matricula=' + row.matricula + '" class="btn btn-primary btn-sm"><i class="fas fa-print"></i></a>';
                },
                "orderable": false,
                "className": "text-center"
            });
