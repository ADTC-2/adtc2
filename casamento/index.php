            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="../gestao_doc/index.php" class="nav-link">
                                <i class="nav-icon fas fa-coins"></i>
                                <p>Upload Doc Assinados</p>
                            </a>
                        </li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title"> <i class="nav-icon fas fa-eye"></i> Visualizar 
                                    </h3>
                                </div>
                                <div class="card-body">
                                    <p>
                                ...
                                <div class="card-footer">
                                    <a href="./listar.php" class="btn btn-primary">Consultar<i
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title"> <i class="nav-icon fas fa-eye"></i> Alterar  
                                    </h3>
                                </div>
                                <div class="card-body">
                                    <p>
                                ...
                                <div class="card-footer">
                                    <a href="./form_alterar.php" class="btn btn-primary">Alterar<i
                                            class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title"><i class="nav-icon fas fa-user-plus"></i> Registrar 
                                    </h3>
                                </div>
                                <div class="card-body">
                                    <p>
                                ...
                                <div class="card-footer">
                                    <a href="./form.php" class="btn btn-primary">Cadastrar<i
                                            class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
