...
$showImprimir = ($_SESSION['nivel'] === 'apoio'); // Verifica se a coluna "Imprimir" deve ser exibida
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    $(document).ready(function() {
        var showImprimir = <?php echo json_encode($showImprimir); ?>;
        ...
        var table = $('#emitirTable').DataTable({
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        return '<a href="mobile.php?matricula=' + row.matricula +
                ...
                <?php if ($showImprimir): ?>
                {
                    ...
                    "render": function(data, type, row) {
                        return '<a href="display_obreiro.php?matricula=' + row.matricula +
        ...
        // Oculta a coluna "Imprimir" se necessário
        if (!showImprimir) {
            table.column(8).visible(false); // Ajuste o índice da coluna "Imprimir" conforme necessário
        }
    });
    </script>
</body>
